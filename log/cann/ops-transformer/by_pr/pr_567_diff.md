# PR #567: Support symmetric memory for aicpu unflod mode

- 作者: linzhenkang
- 分支: tempMerge -> master
- 链接: https://gitcode.com/cann/hcomm-dev/merge_requests/567
- 描述: Support Symmetric Memory
Support symmetric memory for aicpu unflod mode

## 变更文件 (41 个, 其中 C/C++ 文件 34 个)
...
- [modified] src/framework/common/src/CMakeLists.txt (+2, -0)
...
- [modified] src/framework/communicator/impl/hccl_communicator.cc (+5, -0) *
...
- [modified] src/framework/communicator/impl/hccl_communicator_host.cc (+65, -0) *
