# PR #884: Support symmetric memory for aicpu unflod mode

- 作者: linzhenkang
- 分支: pr_870 -> master
- 链接: https://gitcode.com/cann/hcomm-dev/merge_requests/884
...
- [modified] src/framework/communicator/impl/hccl_communicator.h (+7, -0) *
- [modified] src/framework/communicator/impl/hccl_communicator_device.cc (+16, -0) *
- [modified] src/framework/communicator/impl/hccl_communicator_host.cc (+80, -0) *
- [added] src/framework/communicator/impl/symmetric_memory/CMakeLists.txt (+8, -0)
- [added] src/framework/communicator/impl/symmetric_memory/symmetric_memory.cc (+644, -0) *
- [added] src/framework/communicator/impl/symmetric_memory/symmetric_memory.h (+117, -0) *
...
- [modified] src/framework/op_base/src/op_base.cc (+56, -0) *
...
```diff
@@ -1493,5 +1493,25 @@ HcclResult hcclComm::GetKFCWorkSpace(void **addr, uint64_t *size)
     return HCCL_SUCCESS;
 }
...
@@ -4455,6 +4468,49 @@ HcclResult CommGetCCLBufSizeCfg(HcclComm comm, uint64_t *cclBufSize)
